...
#include <fel/time/calendar.hpp>
#include <fel/utilities/errors.hpp>

namespace FEngine {

    void Calendar::addHoliday(const Date& d) {
        FEL_REQUIRE(impl_, "no implementation provided");
    ...
    Date Calendar::adjust(const Date& d,
        ...
        if (c == Following || c == ModifiedFollowing 
            ...
            FEL_FAIL("unknown business-day convention");
        }
        return d1;
    }
